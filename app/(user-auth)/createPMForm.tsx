...
export default function CreatePMForm() {
    ...
    const registrationSuccessful = () => {
        Alert.alert(
            'Sign Up Succesful',
            'Welcome! Your PM account has been created successfully.',
            [
                {
                    text: 'Continue',
                    style: 'cancel',
    ...
    return (
        <ModalTemplate>
            ...
            <View style={styles.formContainer}>
                <Text style={styles.title}>Create PM account</Text>
            </View>
            ...
            <Pressable style={styles.button} onPress={handlePMSignUp}>
